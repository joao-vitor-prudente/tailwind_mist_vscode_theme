...
export type SemanticTokenStyleValue =
  | ColorHex
  | {
      foreground: ColorHex;
      fontStyle?: FontStyle;
...
export type SemanticTokenColors = Partial<Record<SemanticTokenKey, SemanticTokenStyleValue>> &
  Record<string, SemanticTokenStyleValue | undefined>;
...
export type TextMateScopeSelector =
  | "comment"
  | "comment.block"
...
export interface TokenColorRule {
  name?: string;
  scope?: TextMateScopeSelector | readonly TextMateScopeSelector[] | string | readonly string[];
  settings: TextMateTokenSettings;
}

export type TokenColors = readonly TokenColorRule[];

export type Colors = Partial<Record<ThemeColorId, ColorHex>>;
